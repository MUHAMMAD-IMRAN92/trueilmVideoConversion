        ...
        <div class="main-menu-content" style="margin-top: 2rem;">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if (auth()->user()->hasRole('Admin'))
                    ...
                    <li class="@if (request()->is('glossary*')) active @endif "><a href="{{ url('/glossary') }}"><i
                                class="fa fa-list"></i>
                        ...
                        <ul class="menu-content">
                            ...
                            <li class=" nav-item"><a href="#"><i class="fa fa-play"></i><span
                                ...
                                <ul class="menu-content">
                                    ...
                                    <li class="@if (request()->is('books/2') || request()->is('book/2*')) ) active @endif "><a
                            ...
                            <li class=" nav-item"><a href="#"><i class="fa fa-file"></i><span
                                ...
                                <ul class="menu-content">
                                    ...
                                    <li class="@if (request()->is('books/3*') || request()->is('book/3*')) active @endif "><a
