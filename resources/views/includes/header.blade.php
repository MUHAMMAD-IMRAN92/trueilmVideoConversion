                ...
                @if (auth()->user()->hasRole('Admin') ||
                    ...
                    <li class=" nav-item"><a href="#"><i class="fa fa-list-alt"></i><span class="menu-title"
                        ...
                        <ul class="menu-content">
                            ...
                            <li class="@if (request()->is('all_surah_translations/1') || request()->is('surah_translations/1*')) active @endif "><a
                            ...
                            <li class="@if (request()->is('all_surah_translations/2') || request()->is('surah_translations/2*')) active @endif "><a
