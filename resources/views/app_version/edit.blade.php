                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" id="disable-btn-submit"
                                            action="{{ route('glossary.update') }}" method="POST"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                name="id" value="{{ $glossary->id }}"
                                                                placeholder="" required>
                                                                <input type="text" id="" class="form-control"
                                                                    name="title" value="{{ $glossary->title }}"
                                                                    placeholder="" required>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" id="" class="form-control"
                                                                    name="translation"
                                                                    value="{{ glossaryAttribute($glossary->id, 1) }}"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" id="" class="form-control"
                                                                    name="meaning"
                                                                    value="{{ glossaryAttribute($glossary->id, 2) }}"
                                                                    placeholder="" required>
                                                            </div>
                                                        </div>
                                                    </div>
