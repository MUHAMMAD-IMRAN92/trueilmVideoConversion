...
class DevController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        // // Replace certain XML tags with newline characters
        // $response = str_replace('</w:r></w:p></w:tc><w:tc>', "\r\n", $response);
        // $response = str_replace('</w:r></w:p>', "\r\n", $response);

        // // Extract lines containing numbering using regular expression
        // preg_match_all('/[0-9٠-٩].*\r\n/', $response, $matches);
