...
class QuizController extends Controller
{
    ...
    public function checkAnswer(Request $request)
    {
        ...
        if ($lesson) {
          return  $attemptResult =    AttemptResult::where('attempt_id',  $request->attempt_id)->where('lesson_id', $request->lesson_id)->where('user_id', $request->user_id)->where('question_id', $request->question_id)->first();
