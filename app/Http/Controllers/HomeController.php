...
class HomeController extends Controller
{
    ...
    public function AlQuranTranslations()
    {
        ...
        $alQuran = AlQuran::get();
        $lang = '6603b9d40e34c7428db1799b';
        $authors = [
            232 => "6603b62b0e34c7428db1799a",
        ];
        $records = [];
    ...
    public function QuranEncTranslation()
    {
        ini_set('max_execution_time', 0);
        ini_set("memory_limit", "-1");
        $lang = '66051aed0e34c7428db179c1';
        $authors = [
            'indonesian_affairs' => "66051b0c0e34c7428db179c2", 'indonesian_complex' => "66051b160e34c7428db179c3", 'indonesian_sabiq' => "66051b1d0e34c7428db179c4"
        ];
        $records = [];
        foreach ($authors  as $nokey => $arr) {
            $authorLang = AuthorLanguage::where('lang_id', $lang)->where('author_id', $arr)->firstOrCreate([
