...
class HomeController extends Controller
{
    ...
    public function AlQuranTranslations()
    {
        ...
        $alQuran = AlQuran::get();
        $lang = '66011c416e907be5274e2913';
        $authors = [
            106 => "66011cd16e907be5274e2914",
        ];
        $records = [];
    ...
    public function QuranEncTranslation()
    {
        ini_set('max_execution_time', 0);
        ini_set("memory_limit", "-1");
        $lang = '66012a866e907be5274e291d';
        $authors = [
            'chinese_makin' => "6601234b6e907be5274e291b", 'chinese_suliman' => "66012b186e907be5274e291e"
        ];
        $records = [];
        foreach ($authors  as $nokey => $arr) {
            $authorLang = AuthorLanguage::where('lang_id', $lang)->where('author_id', $arr)->firstOrCreate([
