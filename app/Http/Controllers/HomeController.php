...
class HomeController extends Controller
{
    ...
    public function AlQuranTranslations()
    {
        ...
        $alQuran = AlQuran::get();
        $lang = '66278938b5502531b8b21871';
        $authors = [
            51 => "66051b160e34c7428db179c3",
        ];
        $records = [];
    ...
    public function QuranEncTranslation()
    {
        ...
        $authors = [
            'turkish_shaban' => "66278a41b5502531b8b21873",
            'turkish_rwwad' => "6548c59c80681501aab8029b",
            'turkish_shahin' => "66278a9db5502531b8b21874",
        ];
        $records = [];
        foreach ($authors  as $nokey => $arr) {
            $authorLang = AuthorLanguage::where('lang_id', $lang)->where('author_id', $arr)->firstOrCreate([
